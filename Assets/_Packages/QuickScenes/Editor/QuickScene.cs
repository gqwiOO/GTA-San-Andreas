...
using UnityEngine.SceneManagement;
    ...
    public class QuickScene : EditorWindow, IHasCustomMenu
    {
        ...
        /// </summary>
        private static QuickScene current;
        ...
        private const string PATH = "Assets/Resources/QuickScenes";
        private const string QUICKSCENES_SCENES_JSON = "Assets/Resources/QuickScenes/{name}.json";
        private const string SCENES_KEY = "current_scenes";

        #endregion SAVE AND LOAD

        [MenuItem("Tools/Quick Scenes")]
        public static void ShowWindow()
        {
            GetWindow(typeof(QuickScene));
        }
